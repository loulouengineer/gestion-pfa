                ...
                {weekDays.map((d, i) => {
                  ...
                  return (
                    <div key={i} style={{
                      ...
                      <div style={{ fontSize: 11, fontWeight: 700, color: isToday ? "var(--blue-600)" : "var(--text-3)", textTransform: "capitalize", marginBottom: 4 }}>
                        {fmtDay(d)}
                      </div>
                      <button
              ...
              {SLOTS.map((slot, si) => (
                <div key={slot} style={{
                  ...
                  {weekDays.map((d, di) => {
                    ...
                    return (
                      <div key={di}
                        onClick={() => !isPast && handleSlotClick(dateStr, slot)}
                        style={{
                          padding: "4px 6px",
                        ...
                        <div style={{
                          ...
                          onMouseEnter={e => { if (!dispo && !isPast) { e.currentTarget.style.background = "rgba(16,185,129,0.08)"; e.currentTarget.style.border = "1px dashed #10b981"; } }}
                          onMouseLeave={e => { if (!dispo && !isPast) { e.currentTarget.style.background = "transparent"; e.currentTarget.style.border = "none"; } }}
                        >
                          {dispo ? slot : ""}
                        </div>
                      </div>
