...
export default function DashboardPage() {
  ...
  useEffect(() => {
    // ID 1 simulé pour l'étudiant connecté
    ...
    <div style={styles.container}>
      ...
      <div style={styles.grid}>
        ...
        <div style={styles.card}>
          ...
          <div style={styles.cardValue} style={{...styles.cardValue, color: data.currentStep >= 2 ? '#10b981' : '#f59e0b'}}>
            {data.binomeStatus}
          </div>
        ...
        <div style={styles.card}>
          ...
          <div style={styles.cardValue} style={{...styles.cardValue, color: data.currentStep >= 3 ? '#10b981' : '#ef4444'}}>
            {data.sujetStatus}
          </div>
        ...
        <div style={styles.card}>
          ...
          <div style={styles.cardValue} style={{...styles.cardValue, color: '#4361ee'}}>
      ...
      <div style={styles.actionSection}>
        ...
        <div style={styles.actionGrid}>
          {data.currentStep < 2 && (
            <button style={styles.primaryButton} onClick={() => navigate('/mon-binome')}>
              Associer un binôme
            </button>
          )}
          {data.currentStep === 2 && (
            <button style={styles.primaryButton} onClick={() => navigate('/sujets')}>
              Choisir un sujet
            </button>
          )}
          <button style={styles.secondaryButton} onClick={() => navigate('/recommandations')}>
