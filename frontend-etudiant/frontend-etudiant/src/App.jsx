...
const PAGE_META = {
  binome: {
    title: 'Mon binôme',
    sub: 'Recherchez et associez-vous à un partenaire pour votre PFA',
  },
  sujets: {
    title: 'Sujets disponibles',
    sub: 'Parcourez et sélectionnez vos sujets de PFA',
  },
  recommandations: {
    title: 'Recommandations IA',
    sub: 'Sujets suggérés selon votre profil académique',
  },
  'mes-choix': {
    title: 'Mes vœux',
    sub: 'Classez vos préférences et soumettez votre liste finale',
  },
};
...
export default function App() {
  ...
  const [binome, setBinome] = useState(null); // { id, partenaire, moyenneCommune }
  ...
  return (
    <div className="app-layout">
      ...
      <main className="main-content">
        ...
        {/* Avertissement : vœux sans binôme */}
